  ...
  return (
    <section className="section-home-category">
      <div className="container mx-auto px-3">
        <div className="title flex flex-col mb-4 pl-4">
          <div className="flex justify-between">
            <Link
              to={`/collections/`}
              className="hover:text-shop-color-hover text-2xl font-bold"
        ...
        <motion.div className="content overflow-hidden flex pl-4">
          <AnimatePresence>
            {categorySectionItems.map((item, index) => {
              return (
                <motion.div
                  className={clsx("overflow-hidden pr-4")}
                  key={index}
                  style={{ minWidth: `calc(100% / ${perPage})` }}
                  animate={{
